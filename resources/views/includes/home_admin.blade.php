                                <div class="animated homewidget col-md-2">
                                 ...
                                 <div class="animated homewidget col-md-2">
                                    <a href="{{ url('salary') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-money" style="margin-right: 7px;"></i>Salary
                                    </a>
                                </div>
                                 <div class="animated homewidget col-md-2">
                                    <a href="{{ url('expense') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-bolt" style="margin-right: 7px;"></i>Expense
                                    </a>
                                </div>
                                 <div class="animated homewidget col-md-2">
                                    <a href="{{ url('income') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-level-up" style="margin-right: 7px;"></i>Income
                                    </a>
                                </div>
                                 <div class="animated homewidget col-md-2">
                                    <a href="{{ url('') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-level-down" style="margin-right: 7px;"></i>Outcome
                                    </a>
                                </div>
                                 <div class="animated homewidget col-md-2">
                                 ...
                                 <div class="animated homewidget col-md-2">
                                    <a href="{{ url('location') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-location-arrow" style="margin-right: 7px;"></i>Location
                                    </a>
                                </div>
                                 <div class="animated homewidget col-md-2">
                                    <a href="{{ url('shipping') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-truck" style="margin-right: 7px;"></i>Shipping
                                    </a>
                                </div>
                                 <div class="animated homewidget col-md-2">
                                ...
                                <div class="animated homewidget col-md-2">
                                    <a href="{{ url('service_item') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-magic" style="margin-right: 7px;"></i>Service Item
                                    </a>
                                </div>
                                <div class="animated homewidget col-md-2">
                                    <a href="{{ url('service_status') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-check-square-o" style="margin-right: 7px;"></i>Service Status
                                    </a>
                                </div>
                                <div class="animated homewidget col-md-2">
                                ...
                                <div class="animated homewidget col-md-2">
                                    <a href="{{ url('customer') }}" class="bttn btn-default bttn-lg">
                                        <i class="fa fa-user" style="margin-right: 7px;"></i>Customer
                                    </a>
                                </div>