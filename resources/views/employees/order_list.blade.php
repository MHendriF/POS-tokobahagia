                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          @if($order->order_detail_id == '')
                            <td><center><a href="{{ url('order/'.$order->id) }}" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i></a></center></td>
                          @else
                            <td><center><a href="{{ url('order/'.$order->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a></center></td>
                          @endif
