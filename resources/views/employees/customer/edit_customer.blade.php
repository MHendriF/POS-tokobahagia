                    ...
                    <div class="x_content">
                        <form method="post" action="{{ url('customer/'.$data->id) }}" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                   <textarea name="address" class="form-control col-md-7 col-xs-12" required>{{$data->address}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <textarea name="billing_address" class="form-control col-md-7 col-xs-12" required>{{$data->billing_address}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <textarea name="additional_info" class="form-control col-md-7 col-xs-12" required>{{$data->additional_info}}</textarea>
                                </div>
                            </div>
