                  ...
                  <div class="x_content">
                    ...
                    {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                             <textarea required class="form-control" name="po_description" data-parsley-trigger="keyup" data-parsley-minlength="5" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 5 caracters long comment.." data-parsley-validation-threshold="5"></textarea>
                          </div>
                        </div>
