            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Service <small>
                      <a href="{{ url('service/create') }}" class="btn btn-primary btn-xs">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a href="{{ url('service') }}"><i class="fa fa-repeat"></i></a></li>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $index +1 }}</td>
                          <td>{{ $service->pilihteknisi->technician_name }}</td>
                          <td>{{ $service->pilihstatus->status }}</td>
                          <td>{{ $service->cust_name }}</td>
                          <td>{{ $service->cust_phone }}</td>
                          <td>{{ $service->collect_date }}</td>
                          <td><center><img src="{{ asset('/images/services/'.$service->item_images) }}" class="imageResize"></center></td>
                          <td>
                          <center>
                            <div class="btn-group">
                              <a href="{{ url('service/'.$service->id) }}" class="btn btn-primary btn-xs" class="tooltip-top" title="" data-tooltip="View details"><i class="fa fa-eye"></i></a>
                            </div>
                            <div class="btn-group">
                              <a href="{{ url('service/'.$service->id.'/edit') }}" class="btn btn-success btn-xs" class="tooltip-top" title="" data-tooltip="Edit"><i class="fa fa-pencil"></i></a>
                            </div>
                            <div class="btn-group">
