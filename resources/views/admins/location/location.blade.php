                  ...
                  <div class="x_title">
                    <h2>Location List <small>
                      <a href="{{ url('location/create') }}" class="btn btn-primary btn-xs">
                        <i class="fa fa-plus-square" style="margin-right: 6px;"></i>New Location
                      </a>
                      </small>
                    </h2>
                        ...
                        <tr>
                          ...
                          <center>
                            <div class="floating-box">
                              <a href="{{ url('location/'.$location->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                            </div>
                            <div class="floating-box">
                              <a href="{{ url('location/'.$location->id.'/edit') }}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
                            </div>
                            <div class="floating-box">
