                    ...
                    <div class="x_content">
                        <form method="post" action="{{ url('product') }}" class="form-horizontal form-label-left" novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="product_desc" name="product_desc" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="manufacturer" name="manufacturer" required="required" class="form-control col-md-7 col-xs-12" >
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="item_use" name="item_use" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" id="unit_price" name="unit_price" required="required" data-validate-minmax="1,100000" placeholder="Rp" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" id="unit_price2" name="unit_price2" required="required" data-validate-minmax="1,100000" placeholder="Rp" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" id="avg_cost" name="avg_cost" required="required" data-validate-minmax="1,100000" placeholder="Rp" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" id="reorder_lvl" name="reorder_lvl" required="required" data-validate-minmax="1,100000" placeholder="Rp" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <select id="discontinueted" required="required" name="discontinueted" class="select2_single form-control" tabindex="-1">
                                    <option></option>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="pri_vendor" name="pri_vendor" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="sec_vendor" name="sec_vendor" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" id="unit_of_hand" name="unit_of_hand" required="required" data-validate-minmax="10,100000" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="unit_of_measure" name="unit_of_measure" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="images" name="images" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
