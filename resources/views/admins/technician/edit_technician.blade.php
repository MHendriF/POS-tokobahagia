...
@section('title')
    Gentellela Alela! | Edit Technician
@endsection
    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                      <h2>Form Edit Technician <small>sub title</small></h2>
                    ...
                    <div class="x_content">
                        <form method="post" action="{{ url('technician/'.$data->id) }}" class="form-horizontal form-label-left" novalidate>
