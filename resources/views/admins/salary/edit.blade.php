        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form method="post" action="{{ url('salary/'.$data->id) }}" data-parsley-validate class="form-horizontal form-label-left">
                         <input type="hidden" name="_methode" value="PUT">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" name="salary" value="{{$data->salary}}" class="form-control col-md-7 col-xs-12" required/>
                                </div>
                            </div>
