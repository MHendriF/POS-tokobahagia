...
@section('title')
    Toko Bahagia | Edit Service Item
@endsection
                        ...
                        <form method="post" action="{{ url('service_item/'.$data->id) }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" name="serv_item_no" value="{{$data->serv_item_no}}" class="form-control col-md-7 col-xs-12" required/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" name="act_price" value="{{$data->act_price}}" class="form-control col-md-7 col-xs-12" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" name="quantity_in" value="{{$data->quantity_in}}" class="form-control col-md-7 col-xs-12" required/>
                                </div>
                            </div>
                            <div class="form-group">
